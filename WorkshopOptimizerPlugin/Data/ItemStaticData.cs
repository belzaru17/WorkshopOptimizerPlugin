...
internal class ItemStaticData
{
    ...
    {
        Debug.Assert(ItemsData.Length == (Constants.MaxItems + 1));
    }
    ...
    private static readonly ItemStaticData[] ItemsData = {
        ...
        new ItemStaticData(61, "Stove",               12, 4,  54, When.Either, new Categories[]{Data.Categories.Furnishings, Data.Categories.Metalworks},              new Materials[]{Material.Coal[2], Material.IronOre[3], Material.Leucogranite[1]}),
        ...
        new ItemStaticData(63, "Natron",              12, 4,  36, When.Always, new Categories[]{Data.Categories.Sundries, Data.Categories.Confections},                new Materials[]{Material.EffervescentWater[2], Material.RockSalt[2]}),

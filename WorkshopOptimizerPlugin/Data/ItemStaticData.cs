...
internal class ItemStaticData
{
    ...
    private static readonly ItemStaticData[] ItemsData = new ItemStaticData[62]{
        ...
        new ItemStaticData(51, "Coral Sword",         8,  86, When.Either, new Categories[]{Data.Categories.Arms, Data.Categories.MarineMerchandise},          new Materials[]{Material.Coral[3], Material.Resin[3], Material.PalmLog[2]}),
        new ItemStaticData(52, "Coconut Juice",       4,  43, When.Either, new Categories[]{Data.Categories.Confections, Data.Categories.Concoctions},         new Materials[]{Material.Coconut[2], Material.Sugarcane[2]}),
        new ItemStaticData(53, "Honey",               4,  43, When.Either, new Categories[]{Data.Categories.Confections, Data.Categories.Ingredients},         new Materials[]{Material.BeehiveChip[2], Material.Sap[2]}),
        new ItemStaticData(54, "Seashine Opal",       8,  96, When.Either, new Categories[]{Data.Categories.UnburiedTreasures},                                new Materials[]{Material.WoodOpal[4], Material.Sand[4]}),
        new ItemStaticData(55, "Dried Flower",        6,  64, When.Either, new Categories[]{Data.Categories.Sundries, Data.Categories.Furnishings},            new Materials[]{Material.MulticoloredIslebloooms[1], Material.Coconut[2], Material.Sap[1]}),
        new ItemStaticData(56, "Powdered Paprika ",   4,  62, When.Either, new Categories[]{Data.Categories.Ingredients, Data.Categories.Concoctions},         new Materials[]{Material.Paprika[2], Material.Islewort[2]}),

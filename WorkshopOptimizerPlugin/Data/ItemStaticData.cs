...
internal class ItemStaticData
{
    ...
    private static readonly ItemStaticData[] ItemsData = new ItemStaticData[62]{
        ...
        new ItemStaticData( 9, "Sauerkraut",          4,  48, When.Either, new Categories[]{Data.Categories.PreservedFood},                                    new Materials[]{Material.Cabbage[1], Material.RockSalt[3]}),
        new ItemStaticData(10, "Baked Pumpkin",       4,  48, When.Either, new Categories[]{Data.Categories.Foodstuffs},                                       new Materials[]{Material.Pumpkin[1], Material.Sap[3]}),
        ...
        new ItemStaticData(12, "Culinary Knife",      4,  52, When.Either, new Categories[]{Data.Categories.Sundries, Data.Categories.CreatureCreations},      new Materials[]{Material.Claw[1], Material.PalmLog[3]}),
        new ItemStaticData(13, "Brush",               4,  52, When.Either, new Categories[]{Data.Categories.Sundries, Data.Categories.Woodworks},              new Materials[]{Material.Fur[1], Material.PalmLog[3]}),
        new ItemStaticData(14, "Boiled Egg",          4,  52, When.Either, new Categories[]{Data.Categories.Foodstuffs, Data.Categories.CreatureCreations},    new Materials[]{Material.Egg[1], Material.Laver[3]}),
        ...
        new ItemStaticData(19, "Bronze Sheep",        8,  76, When.Always, new Categories[]{Data.Categories.Furnishings, Data.Categories.Metalworks},          new Materials[]{Material.Tinsand[3], Material.CopperOre[3], Material.Log[2]}),
        ...
        new ItemStaticData(26, "Parsnip Salad",       4,  57, When.Either, new Categories[]{Data.Categories.Foodstuffs},                                       new Materials[]{Material.Parsnip[2], Material.Islewort[1], Material.Sap[1]}),
        new ItemStaticData(27, "Caramels",            6,  97, When.Never,  new Categories[]{Data.Categories.Confections},                                      new Materials[]{Material.Sugarcane[4], Material.Milk[2]}),
        new ItemStaticData(28, "Ribbon",              6,  64, When.Always, new Categories[]{Data.Categories.Accessories, Data.Categories.Textiles},            new Materials[]{Material.CottonBoll[2], Material.CopperOre[2], Material.Vine[2]}),
        new ItemStaticData(29, "Rope",                4,  43, When.Always, new Categories[]{Data.Categories.Sundries, Data.Categories.Textiles},               new Materials[]{Material.Hemp[2], Material.Islewort[1], Material.Vine[1]}),
        ...
        new ItemStaticData(32, "Salt Cod",            6,  64, When.Always, new Categories[]{Data.Categories.PreservedFood, Data.Categories.MarineMerchandise}, new Materials[]{Material.Islefish[4], Material.RockSalt[2]}),
        ...
        new ItemStaticData(34, "Essential Draught",   6,  64, When.Always, new Categories[]{Data.Categories.Concoctions, Data.Categories.MarineMerchandise},   new Materials[]{Material.Jellyfish[2], Material.PalmLeaf[2], Material.Laver[2]}),
        new ItemStaticData(35, "Isleberry Jam",       6,  93, When.Never,  new Categories[]{Data.Categories.Ingredients},                                      new Materials[]{Material.Isleberry[3], Material.Sugarcane[2], Material.Sap[1]}),
        new ItemStaticData(36, "Tomato Relish",       4,  62, When.Never,  new Categories[]{Data.Categories.Ingredients},                                      new Materials[]{Material.Tomato[2], Material.Islewort[1], Material.Sap[1]}),
        new ItemStaticData(37, "Onion Soup",          6,  93, When.Never,  new Categories[]{Data.Categories.Foodstuffs},                                       new Materials[]{Material.Onion[3], Material.RockSalt[2], Material.Islewort[1]}),
        new ItemStaticData(38, "Islefish Pie",        6,  93, When.Never,  new Categories[]{Data.Categories.Confections, Data.Categories.MarineMerchandise},   new Materials[]{Material.Wheat[3], Material.Islefish[2], Material.Sugarcane[1]}),
        new ItemStaticData(39, "Corn Flakes",         4,  62, When.Never,  new Categories[]{Data.Categories.PreservedFood},                                    new Materials[]{Material.Corn[2], Material.Sugarcane[2]}),
        new ItemStaticData(40, "Pickled Radish",      8, 124, When.Never,  new Categories[]{Data.Categories.PreservedFood},                                    new Materials[]{Material.Radish[4], Material.Apple[2], Material.Sugarcane[2]}),
        new ItemStaticData(41, "Iron Axe",            8,  86, When.Always, new Categories[]{Data.Categories.Arms, Data.Categories.Metalworks},                 new Materials[]{Material.IronOre[3], Material.Log[3], Material.Sand[2]}),
        new ItemStaticData(42, "Quartz Ring",         8,  86, When.Always, new Categories[]{Data.Categories.Accessories, Data.Categories.UnburiedTreasures},   new Materials[]{Material.Quartz[3], Material.IronOre[3], Material.Stone[2]}),
        new ItemStaticData(43, "Porcelain Vase",      8,  86, When.Always, new Categories[]{Data.Categories.Sundries, Data.Categories.UnburiedTreasures},      new Materials[]{Material.Leucogranite[3], Material.Quartz[3], Material.Clay[2]}),
